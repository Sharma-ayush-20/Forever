...
function Login({setToken}) {
  ...
  return (
    <div className='flex flex-col justify-center mt-5 items-center w-full sm:flex-row'>
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <button className='mt-2 w-full bg-black text-white py-2 px-4' type='submit'>Login</button>
            </form>
        </div>
    </div>
  )
